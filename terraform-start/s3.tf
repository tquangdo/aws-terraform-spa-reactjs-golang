resource "aws_s3_bucket" "dtq-bucket-serverless_series_spa" {
...
resource "null_resource" "upload" {
  depends_on = [
    ...
    aws_s3_bucket.dtq-bucket-serverless_series_spa
  ]
...
data "aws_iam_policy_document" "s3_policy" {
  statement {
    ...
    resources = ["${aws_s3_bucket.dtq-bucket-serverless_series_spa.arn}/*"]
...
resource "aws_s3_bucket_policy" "s3_policy" {
  bucket = aws_s3_bucket.dtq-bucket-serverless_series_spa.id
